...
test.describe('Navigation on navbar', () => {
  test('S01: When I click on "Products" then I should arrive on the products page', async ({
    page,
  }) => {
    await page.goto(URL)
  ...
  test('S02: When I click on "Cart" then I should arrive on the "view_cart" page', async ({
    page,
  }) => {
    await page.goto(URL)
  ...
  test('S03: Signup/login verification - S04:As a non-logged in user when I click on "Signup/Login" I should arrive on the "login" page', async ({
    page,
  }) => {
    await page.goto(URL)
